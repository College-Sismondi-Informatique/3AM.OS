...
boxed title style={
	toprule=2pt,top=2pt,left=-0.1cm,overlay={
		\path[left color=white,right color=colexam,rounded corners=5pt]([yshift=0pt]frame.north east)+(0cm,-23pt) rectangle +(-5.8cm,0pt);}
},
coltitle=white,fonttitle=\Large\bfseries\itshape,
before=\par\medskip\noindent,parbox=false,boxsep=0pt,left=0mm,right=3mm,top=2mm,bottom=5mm,
breakable, pad at break*=0mm,vfill before first,
overlay unbroken={\draw[colexam,line width=1pt,shadowed]
([xshift=-4mm,yshift=-1pt]title.south-|frame.west)--([xshift=-4mm]frame.south west)--(frame.south); },
overlay first={\draw[colexam,line width=1pt,shadowed]
([xshift=-4mm,yshift=-1pt]title.south-|frame.west)--([xshift=-4mm]frame.south west); },
overlay middle={\draw[colexam,line width=1pt,shadowed]
([xshift=-4pt]frame.north west)--([xshift=-4pt]frame.south west); },
overlay last={\draw[colexam,line width=1pt,shadowed]
...
%		\path[left color=white,right color=colexam,rounded corners=5pt]([yshift=0pt]frame.north east)+(0cm,-23pt) rectangle +(-5cm,0pt);}
%},
