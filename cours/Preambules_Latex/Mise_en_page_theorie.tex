...
\addtolength{\oddsidemargin}{+0cm} % 3
\addtolength{\evensidemargin}{-3cm} % 3
\addtolength{\topmargin}{-2.5cm}       % 4
\addtolength{\headheight}{6.1pt}       % 5
\addtolength{\headsep}{-0.4cm}           % 6
\setlength{\textheight}{26.2cm}    % 7
\setlength{\textwidth}{16.5cm}      % 8
\addtolength{\marginparsep}{0pt}      % 9
\setlength{\marginparwidth}{0pt}   % 10
\addtolength{\footskip}{-2mm}           %11
...
%\shadowoffset{1pt}
\chapterfont{\raggedleft\vspace{-1.5cm}\fontsize{36}{0}\fontshape{sl}\selectfont\shadowtext}
\chaptertitlefont{\raggedleft\fontsize{25}{20}\fontshape{sl}\selectfont\shadowtext}
%\shadowoffset{0.7pt}
\sectionfont{\vspace{0.6cm}\hspace{0mm}\fontsize{20}{10}\fontshape{sl}\selectfont }
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% A UTILISER AVEC LE PACKAGE TITLESEC  %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\titleformat{\section}[hang]{}{}{}{}[]
%%%-------------------------------------------------------------------------
%\titleformat{\section}[hang] 
%    {\fontsize{17}{10}\fontshape{bf}\selectfont\fontshape{sl}\selectfont}
%    {\textcolor{black}{\thesection}}
%    {5pt}
%    {\LARGE}
...
\titleformat{\section}
	...
	{\fontsize{19}{22}\bfseries\slshape}% fonte numéro + titre
	{\thesection}% numéro
	{6pt}% espace entre le numéro et le titre
	{}% fonte titre
\titlespacing*{\section}
	{-1.1cm}% retrait à gauche
	{8mm plus 10mm}% espace avant
	{3.5mm plus .3mm}% espace après

\titleformat{\subsection}
	[hang]% style : hang, display, runin, leftmargin, ...
	{\fontsize{15}{17}\bfseries}% fonte numéro + titre
	{\thesubsection}% numéro
	{6pt}% espace entre le numéro et le titre
	{}% fonte titre
\titlespacing*{\subsection}
	{-0.5cm}% retrait à gauche
	{5.3mm plus 2mm }% espace avant
	{3.5mm plus .3mm}% espace après

\titleformat{\subsubsection}
	[hang]% style : hang, display, runin, leftmargin, ...
	{\fontsize{13}{18}\bfseries}% fonte numéro + titre
	{\thesubsection}% numéro
	{6pt}% espace entre le numéro et le titre
	{}% fonte titre
\titlespacing*{\subsubsection}
	{-0.5cm}% retrait à gauche
	{5.3mm plus 1.5mm}% espace avant
	{2mm plus .3mm}% espace après
