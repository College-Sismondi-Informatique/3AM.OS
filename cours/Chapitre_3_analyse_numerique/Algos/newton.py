...
# Définition de la fonction dérivée f'(x)
def df(x):
#    return 12*x**11 
    return 1-0.2*cos(x) # Exercice E4.19 


# Définition de la suite recurrente
# u est l'abscisse de départ et n est le nombre d'itérations.
def newton(u,n):  
...
#Exercice E4.19
print("Zéro de la fonction x-0.2*sin(x)-0.5 : " , newton(1,10))
...
#------------------------------------------
# Suite de Héron. Cas particulier pour le calcul de sqrt(a)
#------------------------------------------
def racine_carree(a,n): # n = nombre d'itérations
    u=1                # abscisse de départ
    for i in range(1,n+1):
        u = 0.5*(u+a/u)
        print("Etape ", i, " : ", u) 
    return u
...
#print("Calcul de racine(2) avec la suite de Héron")
#print(racine_carree(2,5))  
#
#
