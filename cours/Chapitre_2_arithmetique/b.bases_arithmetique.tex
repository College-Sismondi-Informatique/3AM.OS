...
L'arithmétique\footnote{Du grec ancien \guillemets{arithmos} qui signifie \guillemets{nombre}.} est l'étude des propriétés des nombres et des opérations élémentaires entre eux. Elle est, avec la géométrie, une des plus anciennes branches des mathématiques et son origine remonte déjà à l'époque des égyptiens et des babyloniens, qui utilisaient des tables numériques pour calculer et résoudre des problèmes.
%\textgreek{'arijm'os}

\smallskip
Bien que l'arithmétique, dans son sens large, ne se limite pas qu'aux nombres entiers, c'est bien l'étude de ces derniers qui a révélé de grands défis en mathématiques. Certains problèmes d'une grande importance n'ont à ce jour toujours pas été résolus ou démontrés. 
...
La division euclidienne, ou division avec reste, est nommée ainsi en hommage et mathématicien grec Euclide\footnote{Euclide d'Alexandrie était un mathématicien de la Grèce antique qui vécut aux environs de 300 av. JC. Son ouvrage \textit{Les Eléments}  est un des plus anciens et plus célèbres ouvrages des mathématiques.} qui en a posé les fondements.
...
\medskip
{\footnotesize Contre-exemple : \begin{minipage}[t]{0.85\textwidth}
$T=\lbrace 2-\frac{1}{n} \eh{2}\vert\eh{2} n\in \N^{\ast}\rbrace$. Bien qu'il vérifie les conditions 1) et 2), cet ensemble n'a pas de plus grand élément (il est infini).
\end{minipage} }
...
\smallskip
Donc : $$d q \leqslant n \leqslant d (q+1) \ssi[2]$$
$$d q \leqslant n \leqslant d q+d \ssi[2]$$
$$0\leqslant \underbrace{n-dq}_{=r}<d$$
...
\exo
Sans utiliser d'identités remarquables ou la formule de Viète, déterminer tous les nombres relatifs qui sont solution de :
